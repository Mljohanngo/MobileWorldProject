...
{
    public class MWSendPinConfig : IEntityTypeConfiguration<MWSendPin>
    {
        public void Configure(EntityTypeBuilder<MWSendPin> builder)
        {
            ...
            builder.Property(p => p.ClientCorrelator).HasColumnType("varchar(60)");
